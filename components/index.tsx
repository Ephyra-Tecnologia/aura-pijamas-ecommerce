        ...
        <div key={i} className="editorial-col">
          <div className="ed-placeholder">
            <div className="ed-content">
              ...
              <Link href={col.href} className="ed-link">
                {i === 0 ? 'Descobrir' : i === 1 ? 'Ver coleção' : 'Explorar'}
              </Link>
            </div>
          </div>
        </div>
    ...
    <section className="about-strip">
      <div className="about-text">
        ...
        <h2 className="about-heading">
          Valorizamos o <em>desacelerar</em>,<br />o sentir e o viver o momento.
        </h2>
        <p className="about-body">
          Pijamas Aura nasceu para proporcionar conforto, presença e clima de leveza na sua
          melhor hora do dia. Desacelerar, sentir e se reconectar com a sua essência, esse
          é o verdadeiro luxo.
        </p>
    ...
    <section className="newsletter">
      <div>
        <h2 className="newsletter-title">
          Faça parte do<br /><em>universo Aura</em>
        </h2>
      </div>
      ...
      <div className="cart-drawer">
        ...
        {items.length > 0 && (
          <div className="cart-footer">
            ...
            <button className="btn-checkout" onClick={() => { setCartOpen(false); window.location.href = '/checkout' }}>
              Finalizar compra
            </button>
          </div>
        )}
...
export function ProductModal() {
  ...
  const handleAdd = () => {
    addItem(modalProduct, selectedSize)
    closeModal()
